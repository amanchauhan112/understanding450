...
const one = () => {
    ...
    return (
        ...
        <div className="ans_heading">
         ...
         <h2 >Given a grid of dimension nxm where each cell in the grid can have values 0, 1 or 2 which has the following meaning:
         <br/>
0 : Empty cell<br/>
1 : Cells have fresh oranges<br/>
2 : Cells have rotten oranges<br/>

We have to determine what is the minimum time required to rot all oranges. A rotten orange at index [i,j] can rot other fresh orange at indexes [i-1,j], [i+1,j], [i,j-1], [i,j+1] (up, down, left and right) in unit time. </h2>
...
<h4>We need to check for rotten orange top,down,left and right.We will make them 2 if they are 1 and just keep a time track
which will tell you if you are infecting orange using rotten orange or infected orange.<br/>

For this ,we will make a queue that will store your rotten orange coordinates and after 
that it will also keep track or infected oranges .
 ...
 <h4>First we will make a function that will rot top ,bottom ,left and right of element whose coordinates are passed. </h4>
